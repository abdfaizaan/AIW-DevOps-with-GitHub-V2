...
1. Navigate back to **VS Code**, run the command, **cd C:\Workspaces\lab\aiw-devops-with-github-lab-files\src\ContosoTraders.Ui.Website**  to navigate to ContosoTraders.Ui.Website folder.

   Now run the below mentioned command to run ui of the application. This will automatically open a browser tab where you'll see the complete application running
